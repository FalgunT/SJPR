import 'package:sjpr/enum/font_type.dart';
import 'package:flutter/material.dart';

///
/// This class contains
/// all UI related styles
///
...
class AppThemeState extends State<AppTheme> {
  ...
  Color activeTxtColor = const Color(0xffBA9E2E);
  Color buttonTextColor = Colors.black;
  Color buttonBgColor = const Color(0xffBA9E2E);
  Color textFieldBgColor = const Color(0xff2C2D33);
  Color listTileBgColor = const Color.fromRGBO(24, 24, 24, 1);
  Color profileBgColor = const Color(0xFFB49334);
  Color profileListBgColor = const Color(0xFFD4B350);
